...
export const getInventorySubCategories = ({ pageLimit, pageNumber, search = '', orderBy = SORT.inventorySubCategory.orderBy, ordering = SORT.inventorySubCategory.ordering, icId, filterIcId }) => {
  const params = {};
