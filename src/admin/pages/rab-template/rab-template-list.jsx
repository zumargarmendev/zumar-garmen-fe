...
import {
  deleteOperationalUtilityTemplate,
  getOperationalUtilityTemplateList,
...
export default function RABTemplateList() {
  ...
  const handleDeleteRabTemplate = async (outId) => {
    try {
      setLoading(true);
      setError(null);
  ...
  const handleCreateRabTemplateItem = async () => {
    navigate("/admin/rab-template/create");
  };
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      switch (modalAction.type) {
        case "delete":
          await handleDeleteRabTemplate(selectedOrder.outId);
          break;
        default:
                        ...
                        >
                          ...
                          <td className="px-3 py-3 whitespace-nowrap">
                            <ActionDropdown
                              onEditRab={() => {
                                navigate(
                                  `/admin/rab-template/${template.outId}`,
                                );
                              }}
                              onDelete={() =>
                                handleOrderAction(template, {
                                  type: "delete",
                                  title: "Hapus Template RABP",
                                  message:
