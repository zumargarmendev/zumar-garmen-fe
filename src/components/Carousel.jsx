...
export default function Carousel({ slides, rightContent, navigationPosition = "content", autoPlay = false, autoPlayInterval = 4000, height = "h-[90vh]" }) {
    ...
    <div className={`relative w-full ${height} overflow-hidden`}>
      ...
      >
        {slides.map((slide, idx) => (
          <div
            key={slide.id}
            className="w-full h-full flex-shrink-0 bg-cover flex items-center relative"
            style={{ backgroundImage: `url(${slide.image})`, backgroundPosition: slide.backgroundPosition || 'center' }}
          >
            {/* Overlay */}
            ...
            <div className="max-w-7xl w-full mx-auto px-10 md:px-20 flex items-center h-full relative z-10">
              ...
              <div className="w-full md:w-1/2 text-white relative">
                <h2 className="text-2xl md:text-3xl font-semibold font-poppins whitespace-pre-line">
                  {slide.title}
                </h2>
